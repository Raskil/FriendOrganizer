    ...
    public partial class AddedMeetings : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .Index(t => t.Meeting_Id, name: "IX_MeetingFriend_Meeting_Id")
                .Index(t => t.Friend_Id, name: "IX_MeetingFriend_Friend_Id");
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.MeetingFriend", "IX_MeetingFriend_Friend_Id");
            DropIndex("dbo.MeetingFriend", "IX_MeetingFriend_Meeting_Id");
